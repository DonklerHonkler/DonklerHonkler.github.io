...
function draw() {
  // targetting 60 fps
  // using this for time is sketchym v/c no guarante we can
  // achieve target framerate
  background(220);
  drawShape();
...
function keyPressed(){
//automatically called on ay keyboard butten press
// state var: 0 -> 1, 1 ->2 ,
//            2 -> 3, (for 2 seconds) -> 0
if (shapeState < 3) 
  shapeState++;
...
function drawShape() {
  ...
  // optionsm depending on the current value
  switch (shapeState) {
    case 0:
